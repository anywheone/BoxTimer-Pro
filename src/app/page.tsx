        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-8">
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <div className="font-bold text-gray-800">作業</div>
                <div className="text-sm text-gray-500">集中タイム</div>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <div className="font-bold text-gray-800">休憩</div>
                <div className="text-sm text-gray-500">リフレッシュ</div>
              </div>
            </div>
            <div className="text-3xl text-gray-400">→</div>
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <div className="font-bold text-gray-800">作業</div>
                <div className="text-sm text-gray-500">次のタスク</div>
              </div>
            </div>
            <div className="text-3xl text-gray-400">→</div>
            <div className="flex flex-col items-center">
              ...
              <div className="text-center">
                <div className="font-bold text-gray-800">長い休憩</div>
                <div className="text-sm text-gray-500">4回目の後</div>
              </div>
            </div>
          </div>
        </div>
